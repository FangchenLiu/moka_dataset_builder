...
language_instruction_dict = {
    'stage_0': 'Put the golden filler into the box.',
    'stage_1': 'Put the perfume on top of the filler.',
}
...
class GIFTBOX(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for example dataset."""

    VERSION = tfds.core.Version('2.0.0')
    RELEASE_NOTES = {
      '2.0.0': 'giftbox preparation stage 1',
    }
    ...
    def _split_paths(self):
        ...
        episode_paths = crawler('/hdd/data/cvp_raw/gift_preparation/success')
